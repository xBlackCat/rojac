...
class SortedThreadsModel implements TreeModel, TreeTableModel {
    ...
    /**
     * Invoke this method if you've modified the {@code Post}s upon which this model depends. The model will
     ...
     * tree.
     */
    public void nodesChanged(Post node, int[] childIndices) {
        if (node != null) {
